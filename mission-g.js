...
function select_alliance()
{
    ...
    localStorage.setItem("alliance-select", alliance_select.value);
...
function select_anomaly()
{
    ...
    const set_3 = document.getElementById('anomaly-set-3')
    if (set_3)
    {
        const  anomaly_set_3_value = set_3.value;
        localStorage.setItem("m"+mission_num+"-anomaly-set-3", anomaly_set_3_value);
        anomaly = document.querySelector("." + anomaly_set_3_value);
        if (anomaly)
            anomaly.style.display = "block";
    }
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    // alliance_select.value = localStorage.getItem("alliance-select") || "none";
    // select_alliance();
    ...
    const anomaly_set_3 = document.getElementById('anomaly-set-3');
    if (anomaly_set_3)
    {
        anomaly_set_3.addEventListener("change", (_) => {select_anomaly();});
        anomaly_set_3.value = localStorage.getItem("m"+mission_num+"-anomaly-set-3") || "none"; 
    }
    select_anomaly();
